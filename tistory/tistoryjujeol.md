### 180425
1. 한글과 같이 마이너한(구사할 수 있는 인구가 적은) 언어가 은근히 좋은게, 정보가 털릴 확률이 줄어든다. 어떤 정보가 중요한 개인 정보인지 한글을 모르는 이상 알기 어렵고, 알더라도 해석을 하려면 파싱 후 번역기를 돌리기 때문에 정보의 질이 떨어지기 때문이다. 축약어를 최대한 사용하도록 적는 것도(guideline 참고) 모르는 사람이 해석하기 어렵게 만드는 일종의 장치이다.
...
<center><img src="tistoryjujeol_image/0htt.jpg" width ="60%" /></center>
